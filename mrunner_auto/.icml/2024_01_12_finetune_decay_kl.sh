...
# mrunner --config ~/.mrunner.yaml --context athena_nethack_big_1gpu run mrunner_exps/2024_01_12_finetune_decay_kl/2024_01_15_monk-APPO-KS-T-freeze-decay-gamma-reward.py
# mrunner --config ~/.mrunner.yaml --context athena_nethack_big_1gpu run mrunner_exps/2024_01_12_finetune_decay_kl/2024_01_15_monk-APPO-KS-T-freeze_encoder_only-decay-gamma.py