...
# mrunner --config ~/.mrunner.yaml --context athena_nethack_big_1gpu run mrunner_exps/2024_01_09_finetune_mw/2024_01_10_monk-APPO-T_batch_norm.py
# mrunner --config ~/.mrunner.yaml --context athena_nethack_big_1gpu run mrunner_exps/2024_01_09_finetune_mw/2024_01_10_monk-APPO-KS-T_batch_norm.py