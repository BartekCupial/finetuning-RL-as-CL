...
params_grid = [
    {
        ...
        "model_path": [
            "/net/pr2/projects/plgrid/plgggmum_crl/bcupial/sf_checkpoints/amzn-AA-BC_pretrained",
            "/net/pr2/projects/plgrid/plgggmum_crl/bcupial/sf_checkpoints/pretrain_critic_01_18",
        ],
    },
    {
        "seed": list(range(1)),
