...
method_paths = [
    "/net/pr2/projects/plgrid/plgggmum_crl/bcupial/sf_checkpoints",
]
...
for method_path in method_paths:
    ...
    checkpoints = list(filter(lambda p: p.parent.name in ["amzn-AA-BC_pretrained"], checkpoints))
