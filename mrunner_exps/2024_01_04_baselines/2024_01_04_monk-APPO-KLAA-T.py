...
config = {
    ...
    "teacher_path": "/net/pr2/projects/plgrid/plgggmum_crl/bcupial/sf_checkpoints/monk-AA-BC_pretrained_use_prev_action",
...
params_grid = [
    {
        ...
        "model_path": [
            "/net/pr2/projects/plgrid/plgggmum_crl/bcupial/sf_checkpoints/monk-AA-BC_pretrained_use_prev_action"
        ],
    },
]
